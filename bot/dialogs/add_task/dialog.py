...
add_task_dialog = Dialog(
    ...
    Window(
        ...
        Const("<i>Описание:</i>"),
        Const("<i>Высокий — влияет на достижение главных целей и долгосрочный успех.</i>"),
        Const("<i>Средний — полезно, но не критично для ключевых результатов.</i>"),
        Const("<i>Низкий — несущественно, не влияет на важные задачи и цели.</i>"),
        Row(
            Button(
                text=Const("Высокий"),
                id="high",
